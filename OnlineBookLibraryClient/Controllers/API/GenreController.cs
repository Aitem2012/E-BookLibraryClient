...
namespace OnlineBookLibraryClient.Controllers.API
{
    ...
    public class GenreController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("{name}")]
        public IActionResult GetGenre(int name)
        {
            try
            {
        ...
        [HttpPut]
        [Route("update/{name}")]
        public async Task<IActionResult> UpdateGenre(int name, GenreRegisterDTO model)
        {
            try
            {
                var genre = _genre.GetGenre(name);
        ...
        [HttpDelete]
        [Route("delete/{id}")]
        public async Task<IActionResult> DeleteGenre(int name)
        {
            try
            {
                var genre = _genre.GetGenre(name);
